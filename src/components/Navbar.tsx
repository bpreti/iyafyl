...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b" style={{ background: 'rgba(246,245,252,0.9)', backdropFilter: 'blur(12px)', borderColor: 'var(--border)' }}>
              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    background: active ? 'rgba(109,40,217,0.1)' : 'transparent',
                  }}
                >
                  {link.label}
                </Link>
